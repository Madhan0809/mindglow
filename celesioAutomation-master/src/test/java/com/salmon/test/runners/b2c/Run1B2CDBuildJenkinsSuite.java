...
@CucumberOptions(features = "target/test-classes", tags = { "@b2c", "~@b2c_register", "~@b2c_storeLocator", "~@b2c_plp",
		...
		"~@b2c_failed" }, monochrome = true, plugin = { "pretty", "html:target/cucumber-report/run1b2c_dbuild_jenkins",
				"json:target/cucumber-report/run1b2c_dbuild_jenkins/cucumber.json",
				"rerun:target/cucumber-report/run1b2c_dbuild_jenkins/rerun.txt" }, glue = "com.salmon.test")
public class Run1B2CDBuildJenkinsSuite extends AbstractTestNGCucumberTests {
}
